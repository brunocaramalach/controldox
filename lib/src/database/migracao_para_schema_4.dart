...
class MigracaoParaSchema4 extends DatabaseAccessor<AppDatabase> {
  ...
  $PdvTipoPagamentosTable get pdvTipoPagamentos =>
      attachedDatabase.pdvTipoPagamentos;
  $NfeConfiguracaosTable get nfeConfiguracaos =>
      attachedDatabase.nfeConfiguracaos;
  ...
  $NfcePlanoPagamentosTable get nfcePlanoPagamentos =>
      attachedDatabase.nfcePlanoPagamentos;
  ...
  Future<void> migrarParaSchema4(Migrator m, int from, int to) async {
    ...
    await m.addColumn(
        pdvConfiguracaos, pdvConfiguracaos.moduloFiscalContingencia);
    ...
    await m.addColumn(
        nfeConfiguracaos, nfeConfiguracaos.nfceResolucaoImpressao);
